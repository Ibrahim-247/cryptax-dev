...
const ErrorScreen = ({ reset, error }: ErrorProps) => {
        ...
        >
            <div className="p-8 text-center">
                ...
                <motion.div variants={item} className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                    <button
                        onClick={() => reset()}
                        className="px-5 py-2.5 rounded-lg bg-blue-600 text-white font-medium flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors"
                    >
                    ...
                    <button
                        onClick={() => router.push("/")}
                        className="px-5 py-2.5 rounded-lg border border-gray-300 font-medium flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
                    >
