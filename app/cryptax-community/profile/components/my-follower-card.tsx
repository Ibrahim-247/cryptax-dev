...
const MyFollowerCard = ({ follower: follower }: { follower: FollowerType }) => {
    return (
        <div className="w-full hover:shadow-xl transition-all ease-in-out duration-200 p-2 sm:p-4 rounded-md border border-primary-border flex justify-start items-start gap-3 sm:gap-4">
